...
################################################################################
## Form generated from reading UI file 'left_columnBmEWhz.ui'
##
...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        self.btn_1_layout = QHBoxLayout(self.frame_btn_2)
        ...
        self.btn_2_layout = QHBoxLayout(self.frame_btn_1)
        self.btn_2_layout.setSpacing(0)
        self.btn_2_layout.setObjectName(u"btn_2_layout")
        self.btn_2_layout.setSizeConstraint(QLayout.SetDefaultConstraint)
